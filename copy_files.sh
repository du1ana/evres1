#./sashi_release.sh v3.4.24 main kavindu19
#curl -fsSL https://github.com/du1ana/evres1/releases/download/sashi_v3.4.24/setup.sh | cat | sudo SKIP_SYSREQ=1 NO_DOMAIN=1 NETWORK=testnet bash -s install 
#!/bin/bash
